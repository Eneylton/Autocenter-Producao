...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Out-2021 às 02:18
...
ALTER TABLE `produto_temp`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_produto_temp_produtos1_idx` (`produtos_id`),
...
ALTER TABLE `produto_temp`
  ...
  ADD CONSTRAINT `fk_produto_temp_produtos1` FOREIGN KEY (`produtos_id`) REFERENCES `produtos` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
