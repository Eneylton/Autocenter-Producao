...
$resultados = strlen($resultados) ? $resultados : '<tr>
                                                     <td colspan="7" class="text-center" > NenhuM Orçamento Encontrada !!!!! </td>
                                                     </tr>';
               ...
               <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-dark table-bordered table-hover table-striped">
                     <thead>
                        <tr>
                           <td colspan="7">
                              <button type="submit" class="btn btn-info float-right" data-toggle="modal" data-target="#modal-default"> <i class="fas fa-plus"></i> &nbsp; Relatório</button>
                           </td>
                        </tr>
                        <tr>
                           <th> CÓDIGO </th>
