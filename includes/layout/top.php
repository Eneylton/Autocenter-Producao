    ...
    <nav class="main-header navbar navbar-expand navbar-dark  ">
      ...
      <ul class="navbar-nav">
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/fabricante/fabricante-list.php" class="nav-link">Fabricante</a>
        </li>
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/veiculo/veiculo-list.php" class="nav-link">Veículos</a>
        </li>
        <li class="<?php
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/orcamento/orcamento-list.php" class="nav-link">Orçamentos</a>
        </li>
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/orcamento/orcamento-pagamento.php" class="nav-link">Lista de Orçamentos</a>
        </li>
