...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       ...
                       <a href="fabricante-delete.php?id=' . $item->id . '">
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content ">
         <form action="./fabricante-insert.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./fabricante-edit.php" method="POST" enctype="multipart/form-data">
         <div class="modal-content">
            <div class="modal-header">
