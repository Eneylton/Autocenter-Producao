...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content ">
         <form action="./veiculo-insert.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12">
                        <div class="form-group">
                           ...
                           <select class="form-control select" style="width: 100%;" name="fabricante_id" required>
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./veiculo-edit.php" method="POST" enctype="multipart/form-data">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12">
                        <div class="form-group">
                           <label>Nome</label>
                           <input type="text" class="form-control" name="nome" id="veiculo" required>
                        </div>
                     </div>
                     ...
                     <div class="col-12">
                        <div class="form-group">
                           <label>Fabricantes</label>
                           <select class="form-control select" style="width: 100%;" name="fabricante_id" id="fabricante_id" required>
                              <option value=""> Selecione um fabricante</option>
                              <?php
