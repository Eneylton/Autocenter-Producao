...
<table style="margin-top:0px; width: 100%;">
        <tbody>
            <tr style="color:#000">
                ...
                <td style="text-align: right;  font-size: xx-small;"><span style="font-size: 14px; font-weight: unset;">Nº : <?= $codigo ?></span></td>
            </tr>
            <tr style="color:#000">
            ...
            <tr style="color:#000">
                <td style="text-align: left;  font-size: xx-small;" colspan="3">Endereço: </span>&nbsp; <?= $clienteLogradouro ?> &nbsp; Nº <?= $clienteNumero ?> &nbsp; <?= $clienteBairro ?>
