...
define('TITLE','Lista de orçamentos');
...
o.status,
f.nome as pagamento,
cli.nome as cliente',' orcamento AS o
INNER JOIN
clientes AS cli ON (o.clientes_id = cli.id)
INNER JOIN
forma_pagamento AS f ON (o.forma_pagamento_id = f.id)','o.status = 1', 'o.id desc',$pagination->getLimit());

include __DIR__ . '../../../includes/layout/header.php';
include __DIR__ . '../../../includes/layout/top.php';
include __DIR__ . '../../../includes/layout/menu.php';
include __DIR__ . '../../../includes/layout/content.php';
include __DIR__ . '../../../includes/orcamento/pagamento-form-list.php';
